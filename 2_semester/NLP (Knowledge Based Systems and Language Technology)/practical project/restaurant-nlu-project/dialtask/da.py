"""
Dialogue act (DA) representation classes. Note that DAs in Dia are composed
...
class DAI(object):
    ...
    def __lt__(self, other):
        return (self.intent < other.intent or
                (self.intent == other.intent and (other.slot is not None and (self.slot is None or self.slot < other.slot))) or
                (self.intent == other.intent and self.slot == other.slot and
                 (other.value is not None and (self.value is None or self.value < other.value))))
